...
public static final class CTREConfigs {
  ...
  public final class Field{
    ...
    public static final double LONG_SHOT_SHOOTER_ANGLE = 18;
    ...
    public static final double RED_LONG_SHOT_ROBOT_ANGLE = 0;
    public static final double BLUE_LONG_SHOT_ROBOT_ANGLE = 180;
