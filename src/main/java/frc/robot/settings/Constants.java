...
public static final class ShooterConstants{
  ...
  public static final double AUTO_AIM_ROBOT_kP = 0.1;
...
public static final class CTREConfigs {
  ...
  public final class Field{
    ...
    public static final double SPEAKER_Y = 2.157;
    public static final double RED_SPEAKER_X = 0.23;
    public static final double BLUE_SPEAKER_X = 16.412;
