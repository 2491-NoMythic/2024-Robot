...
public class AimRobotMoving extends Command {
    ...
    BooleanSupplier LongShotAngleSup;
  /**
  ...
  public AimRobotMoving(DrivetrainSubsystem drivetrain, DoubleSupplier rotationSupplier, DoubleSupplier translationXSupplier, DoubleSupplier translationYSupplier, BooleanSupplier run, BooleanSupplier PodiumAngleSup, BooleanSupplier FarStageAngleSup, BooleanSupplier SubwooferAngleSup, BooleanSupplier LongShotAngleSup){
        ...
        speedController = new PIDController(
          ...
          this.LongShotAngleSup = LongShotAngleSup;
          this.run = run;
        ...
        public void execute() {
          ...
          } else if(LongShotAngleSup.getAsBoolean()) {
            speedController.setSetpoint(longShotAngle);
          } else { 
